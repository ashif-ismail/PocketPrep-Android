...
public class MainActivity extends AppCompatActivity
    ...
    public void startExam(View v) throws ParseException {
    ...
    public void startQuestionActivity(List<Question> questions) {
        Exam exam = new Exam();
        exam.setQuestions(questions);
        exam.setNumRounds(questions.size());
        ((PocketPrep)getApplication()).setCurrentExam(exam);
